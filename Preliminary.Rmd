...
#regression
regind1<-lm(d_hrwage~w_covid_apr+age+schooling+female+as.factor(occ), data=data_ind, weights=weight)
coeftest(regind1)
```
...
#regression2
regind2<-lm(d_hrwage~w_covid_apr+w_covid_apr_ag+age+schooling+female+as.factor(occ), data=data_ind, weights=weight)
coeftest(regind2)
```
...
#regression
regind1<-lm(d_hrwage~w_covid_apr+age+schooling+female, data=data_ind_ag, weights=weight)
coeftest(regind1)
#regression2
regind2<-lm(d_hrwage~w_covid_apr+w_covid_apr_ag+age+schooling+female, data=data_ind_ag, weights=weight)
coeftest(regind2)
```
